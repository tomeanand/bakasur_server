...
window.onload = function () { "use strict"; gaSSDSLoad("UA-56997910-1"); }; //load after page onload
/*************** REPLACE WITH YOUR OWN UA NUMBER ***********/
...
function initialize(id) {
	"use strict";
	var image = window.bakasur.base_url+'site/images/map_icon.png';
...
function toTop(mobile){
   ...
   if(mobile == false){
    ...
    $('#id_feature_02').click(function (e) {
        e.preventDefault();
        var headerH = $('#mainHeader').outerHeight() -1;
        var $anchor = $('#id_feature_02_t');
        $("html, body").animate({
            scrollTop: $($anchor).offset().top - headerH + "px"
        }, 800, 'easeInOutCirc');

    });

    $('#go_feature').click(function (e) {
        e.preventDefault();
        var headerH = $('#mainHeader').outerHeight() -1;
        var $anchor = $('#paralaxSlice1');
        $("html, body").animate({
            scrollTop: $($anchor).offset().top - headerH + "px"
        }, 800, 'easeInOutCirc');

    });
    $('#more_feature').click(function (e) {
        e.preventDefault();
        var headerH = $('#mainHeader').outerHeight() -1;
        var $anchor = $('#more_feature_link');
        $("html, body").animate({
            scrollTop: $($anchor).offset().top - headerH + "px"
        }, 800, 'easeInOutCirc');
        ...
        $('.plan_price').click(function (e) {
        e.preventDefault();
        var price = $('#id_plan_price').val($(this).attr('data-plan'));
        var headerH = $('#mainHeader').outerHeight() -1;
        var $anchor = $('#contactfrm');
        $("html, body").animate({
            scrollTop: $($anchor).offset().top - headerH + "px"
        }, 800, 'easeInOutCirc');
...
/*
    Used to select the correct work item tab when user clicks on the product square
    Link in the product square causes view to slide to the portfolio section
    This function then brings selected work item to view
*/
function selectPortfolio(tabName) {
